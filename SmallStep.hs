-- Trabalho 2 de semantica formal - Alejandro Pereira
...
-- Exemplo usando IF: Verifica a partir dos valores dos ângulos de um triângulo
-- que estão armazenados nas variáveis "a" , "b" e "c" se é um triângulo
-- retângulo, obtusângulo ou acutângulo, caso seja retângulo seta o valor 
-- 1 na variável r, caso seja obtusângulo seta 2 ou seta 3 caso seja acutângulo.

exSigmaAlejandro :: Memoria
exSigmaAlejandro = [("a",20), ("b",50), ("c",30),("r",0)]

triangulo :: C
triangulo = (If(Or (Igual (Var "a")(Num 90)) 
                   (Or (Igual (Var "b")(Num 90)) 
                       (Igual (Var "c")(Num 90))))
            (Atrib (Var "r")(Num 1))
            (If(Or (Not(Leq (Var "a")(Num 90))) 
                   (Or (Not(Leq (Var "b")(Num 90))) 
                       (Not(Leq (Var "c")(Num 90)))))
            (Atrib (Var "r")(Num 2))    
            (Atrib (Var "r")(Num 3))))

-- Exemplo usando Do While: calcula o numero n da sequência de fibonacci.

exSigmaAlejandro2 :: Memoria
exSigmaAlejandro2 = [("i", 0), ("j", 1), ("n", 10), ("t", 0)]

fibonacci :: C
fibonacci = (If(Igual (Var "n") (Num 1))(Atrib(Var "t")(Num 1))
                    (DoWhile(Seq (Atrib(Var "t") (Soma (Var "i") (Var "j")))
                            (Seq (Atrib(Var "i") (Var "j")) 
                                 (Seq (Atrib(Var "j") (Var "t")) 
                                      (Atrib(Var "n") (Sub(Var "n") (Num 1)))))) (Not(Igual (Var "n") (Num 1)))))      